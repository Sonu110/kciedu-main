...
<div class="container my-24 mx-auto md:px-6">
  <section class="mb-32 text-center">
    ...
    <div class="gap-4 flex flex-wrap  xl:grid xl:grid-cols-4 lg:grid-cols-3 relative">
    <div class="max-w-sm p-7 m-2   rounded-lg  dark:bg-gray-800 dark:border-gray-700">
    <svg class="w-7 h-7 text-yellow-800 dark:text-gray-400 mb-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
    ...
    <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">KCI Institutes boast hundreds of students who have embarked on a delightful journey of learning and achievement.</p>
    <Link to={'/course'} class="inline-flex items-center text-blue-600 hover:underline">
        See All course
    ...
    >
      ...
      {review.map((i) => (
        <SwiperSlide key={i?.id || i?._id}>
          <Reviews img={i.img} name={i.name} des={i.des}  feild={i.feild}/>
        </SwiperSlide>
      ))}
    </Swiper>
