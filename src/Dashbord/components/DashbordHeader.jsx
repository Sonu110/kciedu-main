                  ...
                  <li>
                    <span class="text-base text-gray-900 font-semibold cursor-pointer  rounded-lg flex items-center p-2 hover:bg-gray-100 group relative">
                      <span
                        ...
                        onClick={() => setstuentsubmenu(!stuentsubmenu)}
                      >
                        Students
                        <span
                          className={` ${stuentsubmenu ? "rotate-90  " : " "} `}
                        >
                    ...
                    <ul
                      className={`  shadow-lg  bg-gray-100  top-10 flex flex-col left-0 p-4 gap-3 ${
                        stuentsubmenu ? " " : "hidden"
                      } `}
                    >
                      <li>
                        <Link
